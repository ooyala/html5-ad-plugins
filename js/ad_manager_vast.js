...
OO.Ads.manager(function(_, $) {
  ...
  var Vast = function() {
    ...
    var VERSION_MAJOR_4 = '4';
    var SUPPORTED_VERSIONS = [VERSION_MAJOR_2, VERSION_MAJOR_3, VERSION_MAJOR_4];
    var FEATURES = {
      SKIP_AD : "skipAd",
    ...
    SUPPORTED_FEATURES[VERSION_MAJOR_4] = [FEATURES.SKIP_AD, FEATURES.PODDED_ADS, FEATURES.AD_FALLBACK];
