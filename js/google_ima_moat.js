    ...
    var GoogleIMA = function()
    {
      ...
      var privateMember = _.bind(function(functionVar)
      {
       ...
       /*Copyright (c) 2011-2016 Moat Inc. All Rights Reserved.
        function provided by Moat to include external script to send ad data events to their end
       */
       this.init_moat = function initMoatTracking(a, f, c) {
            ...
            if (google && google.ima && a) {
                var d = "_moatApi" + Math.floor(1E8 * Math.random()), h;
                for (h in google.ima.AdEvent.Type) {
                    var l = function(b) {
                        if (moatapi.sendEvent) {
                            for (b = listeners.length - 1; 0 <= b; b--) a.removeEventListener(listeners[b].type, listeners[b].func);
            ...
            var d = "undefined" !== typeof d ? d : "", e, k;
            try {
      ...
      { 
        ...
        this.moat_conf = metadata.moat_conf;
      ...
      var _IMA_SDK_tryInitAdsManager = privateMember(function()
      {
        ...
        /* Initilize of Moat Object to include external Script */
        if(_uiContainer && _IMAAdsManager && this.moat_conf)
        {
          this.moat_conf.viewMode = google.ima.ViewMode.NORMAL;
          this.init_moat(_IMAAdsManager, this.moat_conf, _uiContainer);
        }
